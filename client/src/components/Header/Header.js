...
const Header = () => {
  return (
    ...
    <div className=' bg-hero bg-no-repeat bg-cover bg-center w-[85vw] m-auto rounded-tr-3xl rounded-tl-3xl h-[70vh]'>
    ...
    <div className='h-[70vh] bg-[#E3E1DC] w-[85vw] m-auto overflow-none rounded-br-2xl rounded-bl-2xl mb-10'>
